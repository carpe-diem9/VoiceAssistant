        ...
        child: Row(
          children: [
            ...
            IconButton(
              ...
              color: chat.deepResearchMode
                  ? theme.colorScheme.primary
                  : Colors.grey,
              tooltip: chat.deepResearchMode
                  ? 'Deep Research 已开启，点击关闭'
                  : '开启 Deep Research 深入调研',
              onPressed: () async {
                await chat.toggleDeepResearch();
                if (mounted) {
                  ScaffoldMessenger.of(context).showSnackBar(
                    SnackBar(
                      content: Text(chat.deepResearchMode
                          ? '已开启 Deep Research 模式'
                          : '已关闭 Deep Research 模式'),
            ...
            Expanded(
              child: TextField(
                ...
                decoration: InputDecoration(
                  hintText: chat.deepResearchMode ? '提问后进行深入调研...' : '输入消息...',
